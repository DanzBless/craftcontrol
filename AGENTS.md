...
- Workspace ID: `4e965e82-903f-41c6-ad33-ea34a871c73d`
- An access token starting with `ngpk_`. Provide it via the `NGODINGPAKEAI_TOKEN`
  ...
  Create one at https://www.ngodingpakeai.com/settings (API keys). Synced content is viewable at https://www.ngodingpakeai.com/workspace/4e965e82-903f-41c6-ad33-ea34a871c73d.
...
2. `npx ngodingpakeai connect --workspace 4e965e82-903f-41c6-ad33-ea34a871c73d --token "$NGODINGPAKEAI_TOKEN"` — link this repo to the workspace (first time only).
...
5. Always report the sync summary and https://www.ngodingpakeai.com/workspace/4e965e82-903f-41c6-ad33-ea34a871c73d. Only pass on links the CLI actually printed — never assemble one from an id yourself.
